...
public class MIPSSimulator {
    ...
    private final static int mask1 = 0b11111100000000000000011111111111; // ADD, ADDU, AND, OR, SLT, SLTU, SRLV, SUB, SUBU
    private final static int mask2 = 0b11111100000000000000000000000000; // ADDI, ADDIU, ANDI, BEQ, BNE, J, JAL, LB, LUI, LW, ORI, SB, SLTI, SLTIU, SW, XORI
    private final static int mask3 = 0b11111100000111110000000000000000; // BGEZ, BGEZAL, BGTZ, BLEZ, BLTZ, BLTZAL,
    private final static int mask4 = 0b11111100000000001111111111111111; // DIV, MULT
    private final static int mask5 = 0b11111100000111111111111111111111; // JR
    private final static int mask6 = 0b11111111111111110000011111111111; // MFHI, MFLO
    private final static int mask7 = 0b11111100000000000000000000111111; // SLL, SLLV, SRA, SRL, SYSCALL, XOR

    public static void main(String[] args) {

        long Instr = main_Memory[PC / 4];
        ...
        if ((Instr & mask1) == addInst) {
            ...
            //f $s == $t advance_pc (offset << 2)); else advance_pc (4)
        }
